...
function handleForm(e){
  e.preventDefault()
  console.log(`FirstName:${firstName} LastName: ${lastName} Compnay:${company} ORGemail: ${orgEmail} Mobile:${mobile} Password:${password} ConfirmPAssword:${cpassword} T&C:${tc}`);
          ...
          <div className="user-all-form userlogin position-relative">
            ...
            <div className="contact-form m-0 py-0">
              ...
              <ul className="nav tabs_signup justify-content-start gap-2">
                ...
                <li className="nav-item">
                  <Link className="nav-link active" to="/recruitor">Recruiter</Link >
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/mentorSignup">Mentor</Link >
                </li>
              </ul>
              <form id="contactForms" className="mt-2" onSubmit={handleForm}>
                <div className="row">
  ...
  <StateSelect
      ...
      />
                  ...
                  <div className="col-lg-12">
                    <div className="form-floating form-group">
                      <input type="text" className="form-control" id="floatingInput" value={company} onChange={(e)=> setCompany(e.target.value)} />
                      <label htmlFor="Company">Company </label>
                    </div>
                  </div>
                  <div className="col-lg-12">
                    <div className="form-floating form-group">
                      <input type="email" className="form-control" id="floatingInput" value={orgEmail} onChange={(e)=> setOrgEmail(e.target.value)} />
                      <label htmlFor="floatingInput">Organization Email</label>
                    </div>
                  </div>
                  <div className="col-lg-12 position-relative">
                    <div className="form-floating form-group">
                      <input type="text" id="mobile_code" className="form-control"  name="name" value={mobile} onChange={(e)=> setMobile(e.target.value)} /> <label>Mobile</label>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-12 form-condition">
                    <div className="agree-label">
                      <input type="checkbox" id="chb1" value={tc} onChange={(e)=> setTc(e.target.checked)}/>
                  ...
                  <div className="col-lg-12 col-md-12">
                    <button  type="submit" className="default-btn w-100 rounded">Submit</button>
