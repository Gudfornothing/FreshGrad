          ...
          <div className="mb-3">
            <div className="card btn-gradient-121 widget-flat">
              ...
              <div className="card-body">
                ...
                <h5 className="text-muted fw-normal mt-0" title="Number of Customers">Completed session</h5>
                <h3 className="mt-2 mb-0">100</h3>
              </div> {/* end card-body*/}
          ...
          <div className="mb-3">
            <div className="card widget-flat btn-gradient-success">
              ...
              <div className="card-body">
                ...
                <h5 className="text-muted fw-normal mt-0" title="Number of Orders">Upcoming session</h5>
                <h3 className="mt-2 mb-0">20</h3>
              </div> {/* end card-body*/}
              <p className="px-3 py-2 mb-0 text-muted border-top">
                <span className="text-success me-2"><i className="ri-upload-cloud-line" /> 5.27%</span>
                <span className="text-nowrap">Since last month</span>
