              ...
              <form id="contactForms" className="mt-5">
                <div className="row">
                  ...
                  <div className="col-lg-12 col-md-12">
                    <Link to="/otp" type="submit" className="default-btn w-100 rounded">
                      Get OTP
                    </Link >
                    <h6 className="mt-4 text-center fw-normal text-muted">Don’t have an account? <Link className="fw-bold" to="/signup">Create an account</Link ></h6>
                  </div>
                </div>
              </form>
            </div>
