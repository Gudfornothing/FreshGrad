          ...
          <div className="user-all-form userlogin position-relative">
            ...
            <div className="contact-form">
             <img src="/src/assets/images/logos/logo-full.png" className="logo_login rounded-pill" alt="Logo" />
              ...
              <p>Code Just Sent to <Link className="fw-bold">opinfo@gmail.com</Link >
              </p><form id="contactForms" className="mt-5">
                <div className="row">
                  ...
                  <div className="col-lg-12 col-md-12">
                    <Link to="/" type="submit" className="default-btn w-100 rounded">
                      Verify
                    </Link >
                    <h6 className="mt-4 text-center fw-normal text-muted">Didn't get the otp? <Link className="fw-bold" to="/forgot-otp">Resend</Link ></h6>
                  </div>
                </div>
              </form>
            </div>
