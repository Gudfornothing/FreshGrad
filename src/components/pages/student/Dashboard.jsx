      ...
      <div className="row">
        ...
        <div className="col-sm-6 col-md-4 col-lg-3">
          <div className="mb-3">
            <div className="card btn-gradient-121 widget-flat">
              <Link to="/session-complete">
                <div className="bg-layerbg"><img src="../src/assets/images/circle.svg"  /></div>
                <div className="card-body">
                  <div className="float-end">
                    <i className="mdi ri-profile-line widget-icon" />
                  </div>
                  <h5 className="text-muted fw-normal mt-0" title="Number of Customers">Networking Courses</h5>
                  <h5 className="mt-2 mb-0">10/25 Session Complete</h5>
                </div> {/* end card-body*/}
          ...
          <div className="mb-3">
            <div className="card widget-flat btn-gradient-success">
              ...
              <div className="card-body">
                ...
                <h5 className="text-muted fw-normal mt-0" title="Number of Orders">Apply Jobs</h5>
          ...
          <div className="mb-3">
            <div className="card widget-flat btn-gradient-danger">
              ...
              <div className="card-body">
                ...
                <h5 className="text-muted fw-normal mt-0" title="Average Revenue">View Courses</h5>
          ...
          <div className="mb-3">
            <div className="card widget-flat btn-gradient-info">
              ...
              <div className="card-body">
                <div className="float-end">
                  <i className="mdi widget-icon ri-user-line" />
                </div>
                <h5 className="text-muted fw-normal mt-0" title="Growth">70% Profile Complete</h5>
        ...
        <div className="col-md-9 mb-3">
          <div className="row">
            ...
            <div className="col-md-6 mb-3">
              <div className="card widget-flat">
                <h4 className="graphtitles">Jobs Apply</h4>
            ...
            <div className="col-md-6 mb-3">
              <div className="card widget-flat">
                <h4 className="graphtitles">70% Profile Complete</h4>
