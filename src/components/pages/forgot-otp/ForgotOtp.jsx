        ...
        <div className="col-lg-6 d-flex p-0">
          <div className="user-all-form userlogin position-relative">
            ...
            <div className="contact-form">
              ...
              <p>Code Just Sent to <span className="fw-bold">opinfo@gmail.com</span></p>
              <form id="contactForms" className="mt-5">
                <div className="row">
                  ...
                  <div className="col-lg-12 col-md-12">
                    <Link to="/new-password" type="submit" className="default-btn w-100 rounded">
                      Verify
                    </Link >
                    <h6 className="mt-4 text-center fw-normal text-muted">Didn't get the otp? <Link className="fw-bold" to="#">Resend</Link ></h6>
                  </div>
                </div>
              </form>
            </div>
