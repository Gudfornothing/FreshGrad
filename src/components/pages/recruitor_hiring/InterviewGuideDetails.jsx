              ...
              <nav className="navbar navbar-expand-md navbar-light p-0">
                ...
                <div className="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                  <ul className="navbar-nav w-100 ms-5">
                    ...
                    <li className="nav-item">
                      <Link className="nav-link active" to="/interview-guide-details">Interview Guide</Link >
                    </li>
                  </ul>
        ...
        <div className="col-md-12">
          ...
          <ul className="nav tabs_signup justify-content-center gap-2 pb-4" id="pills-tab" role="tablist">
            <li className="nav-item flex" role="presentation">
              <button className="nav-link px-5 active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Questions and Answers</button>
            </li>
            <li className="nav-item flex" role="presentation">
              <button className="nav-link px-5" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#videos" type="button" role="tab" aria-controls="videos" aria-selected="false">Video</button>
            </li>
            <li className="nav-item flex" role="presentation">
          ...
          <div className="tab-content" id="pills-tabContent">
            <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
              <img src="../src/assets/images/courses/video1.png" alt />
              <Link className="mt-4">
            ...
            <div className="tab-pane fade" id="videos" role="tabpanel" aria-labelledby="pills-contact-tab">
